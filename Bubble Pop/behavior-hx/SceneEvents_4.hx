...
/* ======================== When Creating ========================= */
        createRecycledActor(getActorType(10), _SpawnPointx, _SpawnPointY, Script.FRONT);
...
if(wrapper.enabled)
{
        ...
        getLastCreatedActor().setAnimation("" + ("" + "Animation 1"));
...
if(wrapper.enabled && 3 == mouseState)
{
        if((Engine.engine.getGameAttribute("Store Points") >= 90))
{
            Engine.engine.setGameAttribute("Number of Bombs", (Engine.engine.getGameAttribute("Number of Bombs") + 1));
            Engine.engine.setGameAttribute("Store Points", (Engine.engine.getGameAttribute("Store Points") - 90));
