...
/* ======================== When Creating ========================= */
        createRecycledActor(getActorType(36), _SpawnPointx, _SpawnPointY, Script.FRONT);
...
if(wrapper.enabled && 3 == mouseState)
{
        if((Engine.engine.getGameAttribute("Store Points") >= 2000))
{
            Engine.engine.setGameAttribute("Background Colout", "Black");
            Engine.engine.setGameAttribute("Store Points", (Engine.engine.getGameAttribute("Store Points") - 2000));
