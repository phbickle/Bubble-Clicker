...
if(wrapper.enabled)
{
        ...
        getLastCreatedActor().setAnimation("" + ("" + "Invisible"));
...
{
        if((Engine.engine.getGameAttribute("Store Points") >= 1000))
{
            Engine.engine.setGameAttribute("Bubble Type", "Invisible");
            Engine.engine.setGameAttribute("Store Points", (Engine.engine.getGameAttribute("Store Points") - 1000));
