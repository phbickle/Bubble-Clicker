...
class Design_4_4_DeltaTime extends SceneScript
{
	
public var _Time:Float;

public var _prevTime:Float;
...
_Time = 0.0;
nameMap.set("prev Time", "_prevTime");
_prevTime = 0.0;
...
propertyChanged("_Time", _Time);
        _prevTime = asNumber(0);
propertyChanged("_prevTime", _prevTime);
