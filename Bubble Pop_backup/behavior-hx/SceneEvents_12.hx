...
/* ======================== When Creating ========================= */
        createRecycledActor(getActorType(40), _SpawnPointx, _SpawnPointY, Script.FRONT);
...
{
            Engine.engine.setGameAttribute("Background Colout", "Star");
